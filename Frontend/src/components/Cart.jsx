            ...
            <div className="mx-auto w-full flex-none lg:max-w-2xl xl:max-w-4xl">
              <div className="space-y-6">
                {cart.length > 0 ? (
                    ...
                    <div key={product._id} className="rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 md:p-6">
                      <div className="space-y-4 md:flex md:items-center md:justify-between md:gap-6 md:space-y-0">
                        <a href="#" className="shrink-0 md:order-1">
                          <img className="h-20 w-20 dark:hidden" src={product.image} alt="Product" />
                        </a>

                        <div className="text-end md:order-4 md:w-32">
                          <p className="text-[20px] font-bold text-gray-900 dark:text-white">${product.price}</p>
                        </div>

                        <div className="w-full min-w-0 flex-1 space-y-1 md:order-2 md:max-w-md">
                          <a href="#" className="leading-3 font-black text-gray-900 hover:underline dark:text-white">{product.productname}</a>
                          <h2 className="text-[8px] leading-3">{product.productdescription}</h2>
                          <div className="flex items-center gap-4">
                            ...
                            <button onClick={() => removeProduct(product._id)} type="button" className="inline-flex items-center text-sm font-medium text-red-600 hover:underline dark:text-red-500">
                              <svg className="me-1.5 h-5 w-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                  ...
                  <h1 className="text-center text-[25px]">Add products to the cart</h1>
                )}
              </div>
            </div>
              ...
              <div className="space-y-4 rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 sm:p-6">
                ...
                <div className="space-y-4">
                  ...
                  <dl className="flex items-center justify-between gap-4 border-t border-gray-200 pt-2 dark:border-gray-700">
                    ...
                    <dd className="text-base font-bold text-gray-900 dark:text-white">${(totalPrice + tax).toFixed(2)}</dd>
                  </dl>
                </div>
